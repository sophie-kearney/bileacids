...
val_dataset = TensorDataset(X_val, y_val, mask_val, time_missing_val, cov_val)
test_dataset = TensorDataset(X_test, y_test, mask_test, time_missing_test, cov_test)
...
with torch.no_grad():
    for test_batch in test_loader:
        X_test_batch, y_test_batch, mask_test_batch, time_missing_test_batch, cov_test_batch = test_batch
